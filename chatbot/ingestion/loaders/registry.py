...
class LoaderRegistry:
    ...
    def register(self, file_extension: str, loader_function: DocumentLoader):
        ...
        if file_extension in self._loaders:
            logger.error("A loader function is already registered for file extension '%s'", file_extension)
    ...
    def load(self, file_path: Path) -> list[Document]:
        ...
        if not loader_function:
            logger.error("No loader registered for file extension: %s", file_extension)
